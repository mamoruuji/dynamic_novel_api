...
type Section struct {
	...
	FrameColor string      `boil:"frame_color" json:"frame_color" toml:"frame_color" yaml:"frame_color"`
	Text       null.String `boil:"text" json:"text,omitempty" toml:"text" yaml:"text,omitempty"`
	TextColor  string      `boil:"text_color" json:"text_color" toml:"text_color" yaml:"text_color"`
	TextSize   int         `boil:"text_size" json:"text_size" toml:"text_size" yaml:"text_size"`
	...
	TermID     null.Int    `boil:"term_id" json:"term_id,omitempty" toml:"term_id" yaml:"term_id,omitempty"`
...
var SectionWhere = struct {
	...
	FrameColor whereHelperstring
	Text       whereHelpernull_String
	TextColor  whereHelperstring
	TextSize   whereHelperint
	...
	TermID     whereHelpernull_Int
	CreatedAt  whereHelpertime_Time
	UpdatedAt  whereHelpertime_Time
}{
	SectionID:  whereHelperint{field: "\"sections\".\"section_id\""},
	Order:      whereHelperint{field: "\"sections\".\"order\""},
	FrameColor: whereHelperstring{field: "\"sections\".\"frame_color\""},
	Text:       whereHelpernull_String{field: "\"sections\".\"text\""},
	TextColor:  whereHelperstring{field: "\"sections\".\"text_color\""},
	TextSize:   whereHelperint{field: "\"sections\".\"text_size\""},
	...
	TermID:     whereHelpernull_Int{field: "\"sections\".\"term_id\""},
...
var (
	sectionAllColumns            = []string{"section_id", "order", "frame_color", "text", "text_color", "text_size", "page_id", "type_id", "position_id", "bubble_id", "image_id", "font_id", "term_id", "created_at", "updated_at"}
	sectionColumnsWithoutDefault = []string{"order", "frame_color", "text_color", "text_size", "page_id", "updated_at"}
	sectionColumnsWithDefault    = []string{"section_id", "text", "type_id", "position_id", "bubble_id", "image_id", "font_id", "term_id", "created_at"}
...
func (o *Section) Term(mods ...qm.QueryMod) termQuery {
	queryMods := []qm.QueryMod{
...
// loaded structs of the objects. This is for an N-1 relationship.
func (sectionL) LoadTerm(ctx context.Context, e boil.ContextExecutor, singular bool, maybeSection interface{}, mods queries.Applicator) error {
	var slice []*Section
	var object *Section
	...
	if singular {
		...
		if !queries.IsNil(object.TermID) {
...
// SetTerm of the section to the related item.
// Sets o.R.Term to related.
// Adds o to related.R.Sections.
func (o *Section) SetTerm(ctx context.Context, exec boil.ContextExecutor, insert bool, related *Term) error {
	var err error
	if insert {
		if err = related.Insert(ctx, exec, boil.Infer()); err != nil {
			return errors.Wrap(err, "failed to insert into foreign table")
	...
	values := []interface{}{related.TermID, o.SectionID}
	...
	queries.Assign(&o.TermID, related.TermID)
	if o.R == nil {
		o.R = &sectionR{
			Term: related,
		}
...
// RemoveTerm relationship.
// Sets o.R.Term to nil.
// Removes o from all passed in related items' relationships struct.
func (o *Section) RemoveTerm(ctx context.Context, exec boil.ContextExecutor, related *Term) error {
	var err error

	queries.SetScanner(&o.TermID, nil)
	if _, err = o.Update(ctx, exec, boil.Whitelist("term_id")); err != nil {
		return errors.Wrap(err, "failed to update local table")
	}
	...
	for i, ri := range related.R.Sections {
		if queries.Equal(o.TermID, ri.TermID) {
			continue
		}
