...
func (r *userR) GetDynamics() DynamicSlice {
	if r == nil {
		return nil
	}
	return r.Dynamics
...
func (r *userR) GetFolders() FolderSlice {
	if r == nil {
		return nil
	}
	return r.Folders
...
func (r *userR) GetImpressions() ImpressionSlice {
	if r == nil {
		return nil
	}
...
func (r *userR) GetMarks() MarkSlice {
	if r == nil {
		return nil
	}
	return r.Marks
...
func (r *userR) GetTerms() TermSlice {
	if r == nil {
		return nil
	}
	return r.Terms
...
var (
	userAllColumns            = []string{"user_id", "name", "email", "created_at", "updated_at"}
	userColumnsWithoutDefault = []string{"user_id", "name", "email", "updated_at"}
...
// Dynamics retrieves all the dynamic's Dynamics with an executor.
func (o *User) Dynamics(mods ...qm.QueryMod) dynamicQuery {
	...
	queryMods = append(queryMods,
		qm.Where("\"dynamics\".\"user_id\"=?", o.UserID),
	)
...
func (o *User) Folders(mods ...qm.QueryMod) folderQuery {
	...
	queryMods = append(queryMods,
		qm.Where("\"folders\".\"user_id\"=?", o.UserID),
	)
...
func (o *User) Images(mods ...qm.QueryMod) imageQuery {
	...
	queryMods = append(queryMods,
		qm.Where("\"images\".\"user_id\"=?", o.UserID),
	)
...
func (o *User) Impressions(mods ...qm.QueryMod) impressionQuery {
	var queryMods []qm.QueryMod
	if len(mods) != 0 {
		queryMods = append(queryMods, mods...)
	}
	...
	queryMods = append(queryMods,
		qm.Where("\"impressions\".\"user_id\"=?", o.UserID),
	)
...
func (o *User) Marks(mods ...qm.QueryMod) markQuery {
	var queryMods []qm.QueryMod
	if len(mods) != 0 {
		queryMods = append(queryMods, mods...)
	}
	...
	queryMods = append(queryMods,
		qm.Where("\"marks\".\"user_id\"=?", o.UserID),
	)
...
func (o *User) Terms(mods ...qm.QueryMod) termQuery {
	var queryMods []qm.QueryMod
	if len(mods) != 0 {
		queryMods = append(queryMods, mods...)
	}
	...
	queryMods = append(queryMods,
		qm.Where("\"terms\".\"user_id\"=?", o.UserID),
	)

	return Terms(queryMods...)
}

// LoadDynamics allows an eager lookup of values, cached into the
// loaded structs of the objects. This is for a 1-M or N-M relationship.
func (userL) LoadDynamics(ctx context.Context, e boil.ContextExecutor, singular bool, maybeUser interface{}, mods queries.Applicator) error {
	var slice []*User
	var object *User
	...
	query := NewQuery(
		qm.From(`dynamics`),
		qm.WhereIn(`dynamics.user_id in ?`, args...),
	)
	if mods != nil {
		mods.Apply(query)
	}
	...
	if err != nil {
		return errors.Wrap(err, "failed to eager load dynamics")
	}

	var resultSlice []*Dynamic
	if err = queries.Bind(results, &resultSlice); err != nil {
		return errors.Wrap(err, "failed to bind eager loaded slice dynamics")
	}

	if err = results.Close(); err != nil {
		return errors.Wrap(err, "failed to close results in eager load on dynamics")
	}
	...
	for _, foreign := range resultSlice {
		for _, local := range slice {
			if local.UserID == foreign.UserID {
				local.R.Dynamics = append(local.R.Dynamics, foreign)
				if foreign.R == nil {
					foreign.R = &dynamicR{}
				}
...
// loaded structs of the objects. This is for a 1-M or N-M relationship.
func (userL) LoadFolders(ctx context.Context, e boil.ContextExecutor, singular bool, maybeUser interface{}, mods queries.Applicator) error {
	var slice []*User
	var object *User
...
func (userL) LoadImages(ctx context.Context, e boil.ContextExecutor, singular bool, maybeUser interface{}, mods queries.Applicator) error {
	...
	query := NewQuery(
		qm.From(`images`),
		qm.WhereIn(`images.user_id in ?`, args...),
	)
	if mods != nil {
		mods.Apply(query)
	}
...
// loaded structs of the objects. This is for a 1-M or N-M relationship.
func (userL) LoadImpressions(ctx context.Context, e boil.ContextExecutor, singular bool, maybeUser interface{}, mods queries.Applicator) error {
	var slice []*User
	var object *User
	...
	query := NewQuery(
		qm.From(`impressions`),
		qm.WhereIn(`impressions.user_id in ?`, args...),
	)
	if mods != nil {
		mods.Apply(query)
	}
...
// loaded structs of the objects. This is for a 1-M or N-M relationship.
func (userL) LoadMarks(ctx context.Context, e boil.ContextExecutor, singular bool, maybeUser interface{}, mods queries.Applicator) error {
	var slice []*User
	var object *User
	...
	query := NewQuery(
		qm.From(`marks`),
		qm.WhereIn(`marks.user_id in ?`, args...),
	)
	if mods != nil {
		mods.Apply(query)
	}
...
// loaded structs of the objects. This is for a 1-M or N-M relationship.
func (userL) LoadTerms(ctx context.Context, e boil.ContextExecutor, singular bool, maybeUser interface{}, mods queries.Applicator) error {
	var slice []*User
	var object *User
	...
	query := NewQuery(
		qm.From(`terms`),
		qm.WhereIn(`terms.user_id in ?`, args...),
	)
	if mods != nil {
		mods.Apply(query)
	}
...
// AddDynamics adds the given related objects to the existing relationships
// of the user, optionally inserting them as new records.
// Appends related to o.R.Dynamics.
// Sets related.R.User appropriately.
func (o *User) AddDynamics(ctx context.Context, exec boil.ContextExecutor, insert bool, related ...*Dynamic) error {
	var err error
	for _, rel := range related {
		if insert {
			...
			values := []interface{}{o.UserID, rel.DynamicID}
	...
	if o.R == nil {
		...
		o.R.Dynamics = append(o.R.Dynamics, related...)
	}
...
// Sets related.R.User appropriately.
func (o *User) AddFolders(ctx context.Context, exec boil.ContextExecutor, insert bool, related ...*Folder) error {
	var err error
	for _, rel := range related {
		if insert {
			rel.UserID = o.UserID
			...
			values := []interface{}{o.UserID, rel.GroupID}
...
// Sets related.R.User appropriately.
func (o *User) AddImages(ctx context.Context, exec boil.ContextExecutor, insert bool, related ...*Image) error {
	var err error
	for _, rel := range related {
		if insert {
			rel.UserID = o.UserID
			...
			values := []interface{}{o.UserID, rel.ImageID}
...
// Sets related.R.User appropriately.
func (o *User) AddImpressions(ctx context.Context, exec boil.ContextExecutor, insert bool, related ...*Impression) error {
	var err error
	for _, rel := range related {
		if insert {
			rel.UserID = o.UserID
			...
			values := []interface{}{o.UserID, rel.ImpressionID}
...
// Sets related.R.User appropriately.
func (o *User) AddMarks(ctx context.Context, exec boil.ContextExecutor, insert bool, related ...*Mark) error {
	var err error
	for _, rel := range related {
		if insert {
			rel.UserID = o.UserID
			...
			values := []interface{}{o.UserID, rel.MarkID}
...
// Sets related.R.User appropriately.
func (o *User) AddTerms(ctx context.Context, exec boil.ContextExecutor, insert bool, related ...*Term) error {
	var err error
	for _, rel := range related {
		if insert {
			rel.UserID = o.UserID
			...
			values := []interface{}{o.UserID, rel.TermID}
